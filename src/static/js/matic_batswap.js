...
$(function() {
    ...
    async function main() {
       ...
       if(currentBlock < startBlock){
        ...
        await loadappleContract(App, tokens, prices, apple_CHEF, apple_CHEF_ADDR, apple_CHEF_ABI, rewardTokenTicker,
            "apple", null, rewardsPerWeek, "pendingapple");

        hideLoading();
      }

      async function loadappleContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
      ...
      for (i = 0; i < poolCount; i++) {
        if (poolPrices[i]) {
          const apr = printapplePool(App, chefAbi, chefAddress, prices, tokens, poolInfos[i], i, poolPrices[i],
    ...
    function printapplePool(App, chefAbi, chefAddr, prices, tokens, poolInfo, poolIndex, poolPrices,
                           totalAllocPoints, rewardsPerWeek, rewardTokenTicker, rewardTokenAddress,
