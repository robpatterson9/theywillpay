...
async function main() {
   ...
   const LONG_CHEF_ADDR = "0x986581a915f8abf4C8E21781a2c45FD4Eb21699D";
   const rewardTokenTicker = "LONG";
   const LONG_CHEF = new ethers.Contract(LONG_CHEF_ADDR, LONG_CHEF_ABI, App.provider);

   const startBlock = await LONG_CHEF.startBlock();
   ...
   if(currentBlock < startBlock){
    ...
    await loadBscChefContract(App, tokens, prices, LONG_CHEF, LONG_CHEF_ADDR, LONG_CHEF_ABI, rewardTokenTicker,
        "long", null, rewardsPerWeek, "pendingLong",[2]);
